function DashboardActions() {
  return (
    <section className="flex items-center justify-between rounded-xl shadow-lg p-6 bg-stone-100">
      <button className="cursor-pointer rounded-lg px-7 py-2 text-white bg-linear-to-r from-blue-100 to-blue-700 hover:scale-105 transition-transform duration-500">
        + Add Expense
      </button>
